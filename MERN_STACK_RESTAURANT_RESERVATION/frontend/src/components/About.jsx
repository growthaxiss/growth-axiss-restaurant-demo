      ...
      <section className="about" id="about">
        <div className="container">
          <div className="banner">
            ...
            <p className="mid">
             At Junkies, we’re more than just a place to eat — we’re where good food meets great vibes. Designed for trendsetters and food lovers aged 18–30, we bring you bold continental and Chinese flavors without burning a hole in your pocket.
